...
(function($) {
  ...
  function recommended() {
    ...
    var recommended_content_padding =
      (recommended_img - recommended_content) / 2;
    if (recommended_content_padding > 0) {
      if (width >= 480) {
        $(".hotel-detail-box").css({
          "padding-top": recommended_content_padding,
          "padding-bottom": recommended_content_padding
        });
      } else {
  ...
  function room_carousel() {
    ...
    if (room_content_padding > 0) {
      if (width >= 992) {
        $(".room-detail").css({
          "padding-top": room_content_padding,
          "padding-bottom": room_content_padding
        });
      } else {
  ...
  function room_carousel_item() {
    ...
    if (room_item_left > 0) {
      if (room_content_padding > 0) {
        if (width >= 992) {
          $(".carousel-contorls").css({
            left: room_item_left,
            top: room_content_padding
          });
        } else if (width <= 991) {
          $(".carousel-contorls").css({
            left: "40px",
            top: room_item_img_height + 40
          });
        } else {
          $(".room-detail").removeAttr("style");
        }
    ...
    if ($(".recommended-section").length) {
      $(".recommended-section").each(function() {
        ...
        $this.appear(function() {
          ...
          $(".recommended-section .hotel-detail-box").addClass(
            "animated flipInX"
          );
        });
      });
