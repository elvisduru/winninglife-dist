...
var MODULE_CONFIG = {
    ...
    treant:         [
                      'libs/treant/vendor/jquery.min.js',
                      'libs/treant/vendor/jquery.easing.js',
                      'libs/treant/vendor/jquery.mousewheel.js',
                      'libs/perfect-scrollbar/perfect-scrollbar.js',
                      'libs/treant/vendor/raphael.js',
                      'libs/treant/Treant.js',
                      'libs/perfect-scrollbar/perfect-scrollbar.css',
                      'libs/treant/Treant.css',
                    ]
  };
